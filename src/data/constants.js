export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1ZW0LnOJBz-3dodafqF_jiWlgfFt1iADQ/view?usp=drive_link",
  ...
  facebook: "https://www.facebook.com/share/18TfAi7z61/",
};
    ...
    skills: [
      {
        name: "Git",
        image:
          "https://i.postimg.cc/mDm2bznh/toppng-com-git-logo-512x512.png",
      },
      {
        name: "GitHub",
        image:
      ...
      },
      {
        name: "Postman",
        image:
          "https://i.postimg.cc/Njw0gcMh/Postman-Logo-Vector.jpg",
      },
      {
        name: "Figma",
        image:
          "https://i.postimg.cc/G36LQsZJ/figma-256-1.png",
      },
    ],
  },
];
...
export const experiences = [
  {
    id: 1,
    img: "https://i.postimg.cc/tCDVmJkS/Screenshot-201.png",
    role: "Advanced Mern Stack",
    company: "Better Tomorrow",
    date: "July 2024 - August 2024",
    desc: "Developed full-stack web apps with the MERN stack, optimizing MongoDB and Node.js APIs. Built responsive React front-ends and integrated PayPal for payments. Delivered solutions in an Agile environment and deployed on Vercel.",
    skills: [
      "React Js",
      "Node Js",
      "Stripe",
  ...
  },
  {
    ...
    desc: "Built responsive, dynamic webpages with Html, CSS, and JavaScript. Integrated MongoDB for user authentication in the MERN stack. Collaborated in teams, using agile to deliver scalable web solutions.",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
...
export const education = [
  ...
  {
    id: 1,
    img: "https://i.postimg.cc/X7kVNsYH/Screenshot-207.png",
    school: "St Joseph's Matriculation Higher Secondary School",
    date: "Mar 2020 - Mar 2020",
    grade: "78.67%",
    desc: "I completed my class 12 high school education at St Joseph's Matriculation Higher Secondary School, Nagercoil.",
  ...
  },
  {
    ...
    grade: "84.60%",
    desc: "I completed my class 10 education at St Joseph's Matriculation Higher Secondary School, Nagercoil.",
    degree: "(X), Computer Science",
  },
];
...
export const projects = [
  {
    ...
    category: "web app",
    github: "https://github.com/RohanManuel/ShopSphere",
    webapp: "https://shopsphere-g3fx.onrender.com",
  },
  {
    id: 1,
    title: "Chatty",
